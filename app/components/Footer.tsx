          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="!text-sm leading-relaxed w-3/4">
                Please note that our advertising partners, including Google, Facebook, and others, are not affiliated with our online store. These companies are not responsible for the products we sell.
                </p>
              </div>
            </div>
